    ...
    return (
        ...
        <div className = "number" >  
             <div>
                 ...
                 { show_Number == true ?  <input type="number"  name = "minutes" className = "input_taker" placeholder = 'Enter Number' onChange={props.myChangeHandler2} ></input> :             
            ...
            <div className = "icons">  
                   { icon_Click == true ? <input className = "start_button" type="button" onClick  = {props.myChangeHandler} /> : 
                   <input className = "pause_button"  type="button"  value = " " onClick  = {props.myChangeHandler3} />     }           
            <label onSubmit={props.myChangeHandler}>
